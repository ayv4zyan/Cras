...
class ReleaseMatrixJourneyTest {
    ...
    private val apiProfiles = listOf(
        26 to "Android 8.0 Oreo (minSdk 26)",
        35 to "Android 15 (targetSdk 35)"
    )
    ...
    fun `executes operator journey across API level matrix`() = runTest(testDispatcher) {
        ...
        for ((apiLevel, profileName) in apiProfiles) {
                        ...
                        return MockResponse().setResponseCode(200).setBody("""
                            {
                                ...
                                "description": "Tested on $profileName",
                                "priority": 2,
                                "plan": null,
                                "labels": [],
                                "parentId": null,
